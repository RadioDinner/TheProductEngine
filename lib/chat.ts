...
/** Same ceiling as every other image ingest (lib/upload-limits.ts). */
export const MAX_CHAT_PHOTO_BYTES = MAX_UPLOAD_BYTES;
...
export const CHAT_SEND_NOTES: Record<string, string> = {
  ...
  badphoto: "That file didn't look like a picture we can accept (jpg, png, gif, or webp).",
