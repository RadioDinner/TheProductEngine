  ...
  return (
    <div className="container prose">
      ...
      <p>
        ...
        <strong>HELP</strong> for help, or call or text <strong>{site.smsNumber}</strong>.
      </p>
      <p>
        <strong>
      ...
      <p>
        Call or text <strong>{site.smsNumber}</strong>, or write to us through the website.
        See also the <Link href="/terms-and-conditions">terms and conditions</Link> and{" "}
