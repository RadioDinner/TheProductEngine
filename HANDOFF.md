...
**1. The 10DLC campaign description at Telnyx is out of date. No code reaches
this.** It still says ads go out **7am–9pm** and **"up to 4 digests a day"**.
Neither is true: the published window is 7am–6pm Mon–Sat (Saturday closes 5pm,
unpublished), and SMS sends in batches rather than fixed digests. The
registered description and the published claim have to agree — this is a
carrier-compliance item, and it has been carried across three sessions now.
